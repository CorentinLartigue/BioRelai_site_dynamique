...
class Menu{
    ...
    public function creerMenuProducteur($composantActif){
        $menu = "<ul class = '" .  $this->style . "'>";
        foreach($this->composants as $composant){
            if($composant[0] == $composantActif){
                $menu .= "<li class='actif'>";
                ...
                $menu .= "<li>";
                $menu .= "<a href='index.php?producteur=" ;
                $menu .=  $composant[0] . "' >";
                $menu .= $composant[1] ;
                $menu .= "</a>";
            }
    ...
    public function creerMenuProduit($composantActif){
        $menu = "<ul class = '" .  $this->style . "'>";
        foreach($this->composants as $composant){
            if($composant[0] == $composantActif){
                $menu .= "<li class='actif'>";
    ...
    public function creerMenuCommande($composantActif)
    {
        $menu = "<ul class = '" .  $this->style . "'>";
        foreach($this->composants as $composant){
            if($composant[0] == $composantActif){
                ...
                $menu .= "<li>";
                $menu .= "<a href='index.php?commande=" ;
                $menu .=  $composant[0] . "' >";
                $menu .= $composant[1] ;
                $menu .= "</a>";
            }
